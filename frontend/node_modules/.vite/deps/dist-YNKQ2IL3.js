...
var argList = new ExternalTokenizer((input, stack) => {
  if (input.next == 40) {
...
var lessHighlighting = styleTags({
  ...
  "AtKeyword Interpolation": tags.special(tags.variableName),
  ...
  Escape: tags.special(tags.string),
  ": ...": tags.punctuation,
...
var spec_identifier = { __proto__: null, lang: 40, "nth-child": 40, "nth-last-child": 40, "nth-of-type": 40, "nth-last-of-type": 40, dir: 40, "host-context": 40, and: 244, or: 244, not: 74, only: 74, url: 86, "url-prefix": 86, domain: 86, regexp: 86, when: 117, selector: 142, from: 172, to: 174 };
var spec_AtKeyword = { __proto__: null, "@import": 126, "@plugin": 126, "@media": 152, "@charset": 156, "@namespace": 160, "@keyframes": 166, "@supports": 178 };
...
var lessLanguage = LRLanguage.define({
  name: "less",
...
var lessCompletionSource = defineCSSCompletionSource((node) => node.name == "VariableName" || node.name == "AtKeyword");
function less() {
...
//# sourceMappingURL=dist-YNKQ2IL3.js.map
